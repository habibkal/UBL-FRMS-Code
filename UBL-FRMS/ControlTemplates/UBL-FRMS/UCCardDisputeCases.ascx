...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCCardDisputeCases.ascx.cs" Inherits="UBL_FRMS.ControlTemplates.UBL_FRMS.UCCardDisputeCases" %>
        ...
        <div id="pnlSearchAddCases" class="panel-collapse collapse ">
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="form-group col-lg-2" style="width: 270px">
                        <label id="lblCallNumber" class="normal-text-2">Call Number</label>
                        <asp:TextBox ID="txtCallNumber" runat="server" CssClass="form-control" placeholder="Call Number" />
                    </div>
                    <div class="form-group col-lg-2">
                        <label id="lblCaseStatus" class="normal-text-2">Card Type</label>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-2">
                        <label id="lblFraudType" class="normal-text-2">Card Type</label>
                        <asp:DropDownList ID="ddlFraudType" runat="server" CssClass="form-control" Style="width: 250px">
                        </asp:DropDownList>
                    </div>
                    <div class="form-group col-lg-1">
                    </div>
...
<div class="row">
    <div class="col-lg-12 wp-h2">
        <div class="col-lg-12 wp-h2">
            <asp:Label ID="lblHeading" runat="server" Text="Card Dispute Cases"></asp:Label>
            <asp:HyperLink CssClass="plus-trc" ID="lnkbtnCreateCPCRequest" runat="server" Width="230px" Text="Create Card Dispute Cases"></asp:HyperLink>
        </div>
        <br />
        ...
        <ContentTemplate>
            <asp:GridView
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="FraudType" HeaderText="Fraud Type" />

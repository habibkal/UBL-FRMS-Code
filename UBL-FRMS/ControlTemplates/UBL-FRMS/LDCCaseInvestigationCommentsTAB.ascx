...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LDCCaseInvestigationCommentsTAB.ascx.cs" Inherits="UBL_FRMS.ControlTemplates.UBL_FRMS.LDCCaseInvestigationCommentsTAB" %>
